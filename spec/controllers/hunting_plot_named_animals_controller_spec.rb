...
describe HuntingPlotNamedAnimalsController do
  ...
  # HuntingPlotNamedAnimalsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested hunting_plot_named_animal as @hunting_plot_named_animal" do
      hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
      get :show, {:id => hunting_plot_named_animal.to_param}, valid_session
      assigns(:hunting_plot_named_animal).should eq(hunting_plot_named_animal)
    end
  end

  describe "GET new" do
    it "assigns a new hunting_plot_named_animal as @hunting_plot_named_animal" do
  ...
  describe "GET edit" do
    it "assigns the requested hunting_plot_named_animal as @hunting_plot_named_animal" do
      hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
      get :edit, {:id => hunting_plot_named_animal.to_param}, valid_session
      assigns(:hunting_plot_named_animal).should eq(hunting_plot_named_animal)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new HuntingPlotNamedAnimal" do
        expect {
          post :create, {:hunting_plot_named_animal => valid_attributes}, valid_session
        }.to change(HuntingPlotNamedAnimal, :count).by(1)
      end

      it "assigns a newly created hunting_plot_named_animal as @hunting_plot_named_animal" do
        post :create, {:hunting_plot_named_animal => valid_attributes}, valid_session
        assigns(:hunting_plot_named_animal).should be_a(HuntingPlotNamedAnimal)
        assigns(:hunting_plot_named_animal).should be_persisted
      end

      it "redirects to the created hunting_plot_named_animal" do
        post :create, {:hunting_plot_named_animal => valid_attributes}, valid_session
        response.should redirect_to(HuntingPlotNamedAnimal.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested hunting_plot_named_animal as @hunting_plot_named_animal" do
        hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
        put :update, {:id => hunting_plot_named_animal.to_param, :hunting_plot_named_animal => valid_attributes}, valid_session
        assigns(:hunting_plot_named_animal).should eq(hunting_plot_named_animal)
      end

      it "redirects to the hunting_plot_named_animal" do
        hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
        put :update, {:id => hunting_plot_named_animal.to_param, :hunting_plot_named_animal => valid_attributes}, valid_session
        response.should redirect_to(hunting_plot_named_animal)
      end
    end

    describe "with invalid params" do
      it "assigns the hunting_plot_named_animal as @hunting_plot_named_animal" do
        hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        HuntingPlotNamedAnimal.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    it "destroys the requested hunting_plot_named_animal" do
      hunting_plot_named_animal = HuntingPlotNamedAnimal.create! valid_attributes
      expect {
