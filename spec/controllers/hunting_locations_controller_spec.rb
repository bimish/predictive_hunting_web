...
describe HuntingLocationsController do
  ...
  # HuntingLocationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested hunting_location as @hunting_location" do
      hunting_location = HuntingLocation.create! valid_attributes
      get :show, {:id => hunting_location.to_param}, valid_session
      assigns(:hunting_location).should eq(hunting_location)
    end
  end

  describe "GET new" do
    it "assigns a new hunting_location as @hunting_location" do
  ...
  describe "GET edit" do
    it "assigns the requested hunting_location as @hunting_location" do
      hunting_location = HuntingLocation.create! valid_attributes
      get :edit, {:id => hunting_location.to_param}, valid_session
      assigns(:hunting_location).should eq(hunting_location)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new HuntingLocation" do
        expect {
          post :create, {:hunting_location => valid_attributes}, valid_session
        }.to change(HuntingLocation, :count).by(1)
      end

      it "assigns a newly created hunting_location as @hunting_location" do
        post :create, {:hunting_location => valid_attributes}, valid_session
        assigns(:hunting_location).should be_a(HuntingLocation)
        assigns(:hunting_location).should be_persisted
      end

      it "redirects to the created hunting_location" do
        post :create, {:hunting_location => valid_attributes}, valid_session
        response.should redirect_to(HuntingLocation.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested hunting_location as @hunting_location" do
        hunting_location = HuntingLocation.create! valid_attributes
        put :update, {:id => hunting_location.to_param, :hunting_location => valid_attributes}, valid_session
        assigns(:hunting_location).should eq(hunting_location)
      end

      it "redirects to the hunting_location" do
        hunting_location = HuntingLocation.create! valid_attributes
        put :update, {:id => hunting_location.to_param, :hunting_location => valid_attributes}, valid_session
        response.should redirect_to(hunting_location)
      end
    end

    describe "with invalid params" do
      it "assigns the hunting_location as @hunting_location" do
        hunting_location = HuntingLocation.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        HuntingLocation.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    it "destroys the requested hunting_location" do
      hunting_location = HuntingLocation.create! valid_attributes
      expect {
